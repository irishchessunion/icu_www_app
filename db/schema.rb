...
ActiveRecord::Schema[7.0].define(version: 2025_08_26_134421) do
  create_table "article_likes", charset: "utf8mb3", force: :cascade do |t|
    t.bigint "article_id"
    t.bigint "user_id"
  ...
  create_table "bad_logins", charset: "utf8mb3", force: :cascade do |t|
    t.string "email"
  ...
  create_table "episodes", charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "failures", charset: "utf8mb3", force: :cascade do |t|
    t.string "name"
    t.text "details"
    t.datetime "created_at"
  ...
  create_table "journal_entries", charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "mail_events", charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "news_likes", charset: "utf8mb3", force: :cascade do |t|
    t.bigint "news_id"
    t.bigint "user_id"
    t.timestamp "created_at"
  ...
  create_table "officers", charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "payment_errors", charset: "utf8mb3", force: :cascade do |t|
    t.integer "cart_id"
    t.string "message"
    t.string "details"
    t.string "payment_name", limit: 100
  ...
  create_table "pgns", charset: "utf8mb3", force: :cascade do |t|
    t.string "comment"
    t.string "content_type"
  ...
  create_table "relays", charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "user_inputs", charset: "utf8mb3", force: :cascade do |t|
    t.integer "fee_id"
    t.string "type", limit: 40
